(function (window, document, $) {
    ...
    $.tmEPOAdmin = {
        ...
        add_events: function () {
            ...
            $(document).on("change.cpf", ".tm_option_enabled", function () {
        ...
        builder_panel_add_onClick: function (e) {
            ...
            if (_clone) {
                ...
                _clone.find(".tm_option_enabled").val("1");
        ...
        validate_rule: function (rule, bitem) {
            ...
            if (!globalVariationObject || !rule || typeof rule !== "object" || !("element" in rule) || !("operator" in rule) || !("section" in rule) || (!("value" in rule ) && !(rule.operator === "isempty" || rule.operator === "isnotempty") ) ) {
        ...
        builder_delete_onClick: function () {
            ...
            if (confirm(TMEPOGLOBALADMINJS.i18n_builder_delete)) {
                ...
                if (_bitem.is(".element_is_disabled")){
            ...
            $.tcFloatBox({
                ...
                "updateEvent": function (inst) {
                    ...
                    if (original_enabled !== new_enabled) {
                        ...
                        section.find(".bitem").each(function (i, el) {
                            el = $(el);
                            rules = el.find(".tm-builder-clogic").val() || "null";
                            rules = $.epoAPI.util.parseJSON(rules);
        ...
        builder_clone_onClick: function (e) {
            ...
            if (_clone) {
                ...
                radios = _bitem.find(":radio").add(_bitem.filter(":radio"));
                resultRadios = _clone.find(":radio").add(_clone.filter(":radio"));

                for (i = 0, l = radios.length; i < l; i += 1) {
                    if ($(resultRadios[i]).is(":checked")){
