            ...
            field.tm_datepicker({
                ...
                onSelect: function () {
                    ...
                    if (date) {
                        ...
                        string = $.tm_datepicker.formatDate(format, date);
                        if (disabled_months.indexOf(month.toString()) !== -1 || disabled_weekdays.indexOf(day.toString()) !== -1 || disabled_dates.indexOf(string) !== -1 || (enabled_only_dates !== "" && enabled_only_dates.indexOf(string) === -1)) {
