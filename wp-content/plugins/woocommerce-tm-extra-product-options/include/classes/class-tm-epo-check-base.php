...
final class THEMECOMPLETE_EPO_CHECK_base {
	...
	/**
	 * Check for compatible WooCommerce Multilingual configuration
	 *
	 * @since 1.0
	 * @static
	 */
	public function wcml_check() {
	...
	public function wcml_notice() {

		echo '<div class="error fade"><h4>WooCommerce TM Extra Product Options</h4><p>';
		echo sprintf( esc_html__( '%sImportant:%s Your version of WooCommerce Multilingual plugin is not supported and will cause loss of data.', 'woocommerce-tm-extra-product-options' ),
			'<strong>', '</strong>' );
		echo '</p></div>' . "\n";
