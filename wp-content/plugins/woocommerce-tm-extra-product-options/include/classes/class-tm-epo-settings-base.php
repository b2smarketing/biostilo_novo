...
final class THEMECOMPLETE_EPO_SETTINGS_base {
	...
	public function get_setting_array( $setting, $label ) {
		...
		if ( is_callable( array( $this, $method ) ) ) {
			...
			foreach ( $settings as $key => $setting_array ) {
				if ( isset( $setting_array['type'] ) && ( $setting_array['type'] === 'checkbox' || $setting_array['type'] === 'textarea' ) && isset( $setting_array['desc'] ) && $setting_array['desc'] !== '' ){
	...
	public function settings_options() {
		$settings_options = array(
			"general" => esc_html__( 'General', 'woocommerce-tm-extra-product-options' ),
			"display" => esc_html__( 'Display', 'woocommerce-tm-extra-product-options' ),
			"cart"    => esc_html__( 'Cart', 'woocommerce-tm-extra-product-options' ),
			"order"   => esc_html__( 'Order', 'woocommerce-tm-extra-product-options' ),
			"string"  => esc_html__( 'Strings', 'woocommerce-tm-extra-product-options' ),
			"style"   => esc_html__( 'Style', 'woocommerce-tm-extra-product-options' ),
			"global"  => esc_html__( 'Global', 'woocommerce-tm-extra-product-options' ),
			"other"   => "other",
			"license" => esc_html__( 'License', 'woocommerce-tm-extra-product-options' ),
			"upload"  => esc_html__( 'Upload manager', 'woocommerce-tm-extra-product-options' ),
			"code"    => esc_html__( 'Custom code', 'woocommerce-tm-extra-product-options' ),
		);
	...
	public function _get_setting_general( $setting, $label ) {
		return array(
			array(
				'type'  => 'tm_title',
				'id'    => 'epo_page_options',
				'desc'  => '<span data-menu="tcinit" class="tm-section-menu-item">' . esc_html__( 'Initialization', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				           '<span data-menu="tcftb" class="tm-section-menu-item">' . esc_html__( 'Final total box', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				           '<span data-menu="tcvarious" class="tm-section-menu-item">' . esc_html__( 'Various', 'woocommerce-tm-extra-product-options' ) . '</span>',
				'title' => $label,
			),
			array(
	...
	public function _get_setting_display( $setting, $label ) {
		return array(
			array(
				'type' => 'tm_title',
				'id'   => 'epo_page_options',
				'desc' => '<span data-menu="tcdisplay" class="tm-section-menu-item">' . esc_html__( 'Display', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				          '<span data-menu="tcplacement" class="tm-section-menu-item">' . esc_html__( 'Placement', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				          '<span data-menu="tcprice" class="tm-section-menu-item">' . esc_html__( 'Price', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				          '<span data-menu="tcftbox" class="tm-section-menu-item">' . esc_html__( 'Floating Totals box', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				          '<span data-menu="tcanimation" class="tm-section-menu-item">' . esc_html__( 'Animation', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				          '<span data-menu="tcvarious2" class="tm-section-menu-item">' . esc_html__( 'Various', 'woocommerce-tm-extra-product-options' ) . '</span>',
	...
	public function _get_setting_order( $setting, $label ) {
		return array(
			...
			array(
				...
				'desc'    => esc_html__( 'Enable this if you are getiing a 500 error when trying to complete the order in the checkout.', 'woocommerce-tm-extra-product-options' ),
	...
	public function _get_setting_global( $setting, $label ) {
		return array(
			array(
				'type'  => 'tm_title',
				'id'    => 'epo_page_options',
				'desc'  => '<span data-menu="tcglobal1" class="tm-section-menu-item">' . esc_html__( 'General', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				           '<span data-menu="tcglobal2" class="tm-section-menu-item">' . esc_html__( 'Visual', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				           '<span data-menu="tcglobal3" class="tm-section-menu-item">' . esc_html__( 'Product page', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				           '<span data-menu="tcglobal4" class="tm-section-menu-item">' . esc_html__( 'Elements', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				           '<span data-menu="tcglobal5" class="tm-section-menu-item">' . esc_html__( 'Locale', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				           '<span data-menu="tcglobal6" class="tm-section-menu-item">' . esc_html__( 'Pricing', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				           '<span data-menu="tcglobal7" class="tm-section-menu-item">' . esc_html__( 'Strings', 'woocommerce-tm-extra-product-options' ) . '</span>' .
				           '<span data-menu="tcglobal8" class="tm-section-menu-item">' . esc_html__( 'Various', 'woocommerce-tm-extra-product-options' ) . '</span>',
				'title' => $label,
			),
			array(
			...
			array(
				...
				'desc'    => esc_html__( 'This will rever the option values to the default ones after addign the product to the cart', 'woocommerce-tm-extra-product-options' ),
	...
	public function _get_setting_upload( $setting, $label ) {
		...
		.  '<a class="tm-mn-movetodir" data-tm-dir="" href="#">' . esc_html__( 'Enable File manager', 'woocommerce-tm-extra-product-options' ) . '</a>'
		. '</div></div>';
